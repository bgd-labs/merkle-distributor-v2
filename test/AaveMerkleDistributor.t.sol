...
contract AaveMerkleDistributorTest is Test {
  ...
  IERC20 constant AAVE_TOKEN = IERC20(0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9);
  IERC20 constant USDT_TOKEN = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
  bytes32 constant MERKLE_ROOT = 0x46cf998dfa113fd51bc43bf8931a5b20d45a75471dde5df7b06654e94333a463;
  ...
  bytes32[] claimerMerkleProof = [
    bytes32(0x63d0b615933f386743984cf04df28f9b3baab05af7ba535d8252bf2a9b4e9369),
  ...
  function testAddSingleDistribution() public {
    ...
    IAaveMerkleDistributor.DistributionWithoutClaimed memory distribution = aaveMerkleDistributor
      .getDistribution(0);
  ...
  function testAddMultipleDistributions() public {
    ...
    IAaveMerkleDistributor.DistributionWithoutClaimed memory distribution1 = aaveMerkleDistributor
      .getDistribution(1);
  ...
  function testClaimMultipleTokens() public {
    ...
    deal(address(UNI_TOKEN), address(aaveMerkleDistributor), 10000000 ether);
    ...
    aaveProof[0] = 0xe3fa4410a98d607c1a3998c5909077d3704f237c54e7e1efc55770a5c34a0d3a;
    aaveProof[1] = 0xc2ce9657a14abf91de36abb0117cff51520ba9ccfa4a36a9c54376938a577584;
    aaveProof[2] = 0x9c7e98996455158e0ff16f5612ef668fae9374ef0be8ba3f4d020369521542e1;
    aaveProof[3] = 0x9c572b9c47e83c7d60076a98eb5afdb7b2e95c9c01404f387a447e9d38ddc7b6;
    aaveProof[4] = 0x88f162d63b680096ea25bdc6a9b3d1580ce1ec2c18187d9653a2a9231b35883f;
    aaveProof[5] = 0x8dedbbeb64019e1d0e8e5a9c35c24a47f2dcd239a086fb558eac0c5e4e6dd074;
